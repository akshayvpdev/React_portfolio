              ...
              <div className="row align-items-center">
                ...
                <div className="col-12 col-lg-7 col-sm-12 mb-30">
                  ...
                  <div className="about-content">
                    <p>
                      Self taught developer with a strong foundation in MERN
                      stack web development. Proficient in JavaScript, Node.js,
                      React, and MongoDB. Proven ability to learn quickly and
                      work well in a team. Passionate about creating
                  ...
                  <div className="about-btns">
                    <div className="about-btn">
                      <a
                        download={"Akshay.pdf"}
                        href="/Akshay.pdf"
                        className="btn btn-color btn-space">
                        Download CV
                      </a>
                    </div>
                  </div>
